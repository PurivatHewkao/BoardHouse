...
| ----- | ----------------------- | ----- | ------------ | ----- |
| 1     | ภูริวัชร์ จินดาพงษ์ศิริ | T003  | 67182803     | |
| 2     | ภานุกร แสงมณี           | T001  | 67161002     | |
| 3     | บุรพร วันทอง            | T001  | 67167437     | |
| 4     | กนก รัตนเรืองรักษ์      | T001  | 67188118     | |
...
ในการเรียนรู้การพัฒนาซอฟต์แวร์ มักให้ความสำคัญกับทักษะเทคนิคเป็นหลัก แต่ในโลกการทำงานจริง ทักษะที่ขาดไม่ได้คือความสามารถในการทำงานร่วมกับผู้อื่นได้อย่างมีประสิทธิภาพ ไม่ว่าจะเป็นการสื่อสารที่ชัดเจน การแบ่งความรับผิดชอบ การรับและให้ feedback และการประสานงานให้งานเดินหน้าได้แม้เจอปัญหา

โครงการนี้จึงถูกออกแบบมาเพื่อเติมเต็มช่องว่างนั้น โดยสร้างสภาพแวดล้อมจำลองการทำงานจริงที่ทีมต้องพึ่งพากันตลอดกระบวนการ การเลือกพัฒนาเว็บขายบอร์ดเกมเป็นโจทย์ เพราะมีขอบเขตชัดเจน ความซับซ้อนพอดี และแบ่งงานได้หลายส่วน 

สิ่งที่ทีมจะได้กลับไปจากโครงการนี้จึงไม่ใช่แค่เว็บไซต์ที่เสร็จสมบูรณ์ แต่คือประสบการณ์และความเข้าใจในกระบวนการทำงานร่วมกัน ซึ่งเป็นทักษะที่ติดตัวและนำไปใช้ได้ในทุกโครงการต่อจากนี้

บอร์ดเกมได้รับความนิยมเพิ่มขึ้นอย่างต่อเนื่องในประเทศไทย แต่ผู้ที่ต้องการซื้อยังเผชิญปัญหาหลายประการ ได้แก่ สินค้ากระจัดกระจายหลายร้าน ราคาไม่โปร่งใส และข้อมูลสินค้าไม่เพียงพอต่อการตัดสินใจ โครงการนี้จึงเกิดขึ้นเพื่อสร้างพื้นที่ศูนย์กลางสำหรับนักเล่นบอร์ดเกม ที่รวบรวมสินค้าไว้ครบในที่เดียว ราคายุติธรรม พร้อมข้อมูลที่ช่วยให้การเลือกซื้อง่ายและมั่นใจขึ้น
