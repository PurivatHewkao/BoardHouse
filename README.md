...
User Persona ของ BoardHouse แบ่งตามบทบาทหลักของระบบ 3 กลุ่ม ได้แก่ Customer, Admin และ Super Admin เพื่อให้การออกแบบฟีเจอร์สอดคล้องกับเป้าหมาย ความต้องการ และข้อจำกัดของผู้ใช้งานแต่ละประเภท

### Persona 1: Customer

| หัวข้อ | รายละเอียด |
| --- | --- |
| ชื่อ | เฉลิม วงศ์วานิช |
| บทบาท | Customer / ผู้ซื้อสินค้า |
| อายุ | 23 ปี |
| อาชีพ | นักศึกษาและฟรีแลนซ์ |
| การใช้งาน | มือถือเป็นหลัก |
| ความถี่ | เลือกซื้อเดือนละ 1-2 ครั้ง |
| Quote | “อยากหาเกมที่เหมาะกับเพื่อน ๆ ได้เร็ว และรู้ทันทีว่ามีของหรือไม่” |

**เป้าหมาย**

- ค้นหาเกมที่เหมาะกับจำนวนผู้เล่นและช่วงอายุได้รวดเร็ว
- เปรียบเทียบราคา รายละเอียด และสต็อกก่อนตัดสินใจ
- สั่งซื้อและติดตามสถานะออเดอร์ได้โดยไม่ซับซ้อน

**ความต้องการ**

- ระบบค้นหาและกรองตามหมวดหมู่ อายุ และจำนวนผู้เล่น
- ข้อมูลสินค้า ราคาเงินบาท และสต็อกที่เป็นปัจจุบัน
- ตะกร้า ที่อยู่จัดส่ง และประวัติคำสั่งซื้อที่ใช้งานง่าย

**ความท้าทาย**

- มีเกมให้เลือกมากจนไม่แน่ใจว่าเกมใดเหมาะกับกลุ่ม
- กังวลว่าสต็อกหรือราคาในหน้าร้านไม่ตรงกับข้อมูลจริง
- ไม่ต้องการขั้นตอน Checkout ที่ยาวหรือกรอกข้อมูลซ้ำ

**เส้นทางหลัก**

1. ค้นหาและกรองเกม
2. ดูรายละเอียดสินค้า
3. เพิ่มลงตะกร้าและ Checkout
4. ติดตามคำสั่งซื้อ
...
| หัวข้อ | รายละเอียด |
| --- | --- |
| ชื่อ | กิตติพงศ์ สายใจ |
| บทบาท | Admin / ผู้ดูแลร้าน |
| อายุ | 28 ปี |
| อาชีพ | เจ้าหน้าที่ร้านค้าออนไลน์ |
| การใช้งาน | คอมพิวเตอร์เป็นหลัก |
| ความถี่ | ใช้งานทุกวัน |
| Quote | “ต้องเห็นสต็อกและออเดอร์ชัดเจน เพื่อดูแลหน้าร้านได้โดยไม่ตกหล่น” |

**เป้าหมาย**

- เพิ่ม แก้ไข และลบสินค้าได้อย่างรวดเร็ว
- รักษาจำนวนสต็อกให้ตรงกับการซื้อขายจริง
- ติดตามลูกค้าและอัปเดตสถานะคำสั่งซื้อได้ครบถ้วน

**ความต้องการ**

- Dashboard สรุปสินค้า ออเดอร์ ลูกค้า และยอดขาย
- Product Management พร้อมรูป ราคา หมวดหมู่ และตัวกรองสต็อก
- Order Management สำหรับดูรายละเอียด เปลี่ยนสถานะ และยกเลิกออเดอร์

**ความท้าทาย**

- ข้อมูลสินค้ายุ่งยากและเสี่ยงไม่ตรงกัน
- หากสินค้าที่ใกล้หมดไม่ถูกแจ้งเตือน อาจเกิดปัญหาขายเกินจำนวน
- การแก้ไขข้อมูลซ้ำ ๆ ใช้เวลานานและเกิดข้อผิดพลาดง่าย

**เส้นทางหลัก**

1. ตรวจ Dashboard
2. อัปเดตสินค้าและสต็อก
3. ตรวจคำสั่งซื้อ
4. ดูข้อมูลลูกค้า
...
| หัวข้อ | รายละเอียด |
| --- | --- |
| ชื่อ | ศิริพร ตั้งมั่น |
| บทบาท | Super Admin / ผู้ควบคุมระบบ |
| อายุ | 35 ปี |
| อาชีพ | เจ้าของร้านและผู้จัดการระบบ |
| การใช้งาน | คอมพิวเตอร์และแท็บเล็ต |
| ความถี่ | ตรวจระบบทุกวัน |
| Quote | “ต้องควบคุมทั้งร้านและสิทธิ์ทีมงาน โดยไม่ให้ผู้ใช้ทั่วไปเข้าถึงข้อมูลสำคัญ” |

**เป้าหมาย**

- ควบคุมสิทธิ์ผู้ดูแลระบบอย่างปลอดภัย
- เห็นภาพรวมการดำเนินงานและความผิดปกติของร้าน
- ทำให้ทีม Admin ดูแลสินค้าและออเดอร์ได้อย่างมีประสิทธิภาพ

**ความต้องการ**

- ความสามารถทั้งหมดของ Admin
- เพิ่ม ลบ เลื่อนขั้น และลดขั้นบัญชี Admin
- Role guard ที่แยก Customer, Admin และ Super Admin ชัดเจน

**ความท้าทาย**

- กังวลว่าบุคคลที่ไม่มีสิทธิ์จะเข้าถึงหน้า Admin
- การเปลี่ยนผู้รับผิดชอบทำให้บัญชีและสิทธิ์ติดค้าง
- ต้องติดตามภาพรวมโดยไม่ต้องลงไปตรวจทุกรายการด้วยตนเอง

**เส้นทางหลัก**

1. ตรวจ Dashboard
2. ตรวจสิทธิ์และบัญชี Admin
3. กำกับดูแลสินค้าและออเดอร์
4. รีเซ็ตข้อมูลจำลองเมื่อจำเป็น

### ตารางเปรียบเทียบความสามารถหลัก

| ความสามารถหลัก | Customer | Admin | Super Admin |
| --- | --- | --- | --- |
| ค้นหา ซื้อสินค้า และดูออเดอร์ของตนเอง | ✓ | - | - |
| จัดการสินค้า ลูกค้า และคำสั่งซื้อ | - | ✓ | ✓ |
| เพิ่ม ลบ เลื่อนขั้น หรือลดขั้น Admin | - | - | ✓ |
...
```json
{
  ...
  "schemas": {
    ...
    "Order": {
      ...
      "total": "number",
      "status": "Paid | Preparing Shipment | In Transit | Completed | Cancelled",
      "tone": "string",
...
| ----- | ----------------------- | ----- | ------------ | ----- |
| 1 | Overall Team's UAT | | | [UAT Result](https://quilled-edge-054.notion.site/UAT-22-7-Result-3a5dadaf37a2801bb069f593f2df67b4?source=copy_link) |
