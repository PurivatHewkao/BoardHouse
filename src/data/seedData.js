...
export const orders = [
  {
    ...
    items: "Catan, Uno",
    orderItems: [
      { productId: 1, name: "Catan", price: 1400, quantity: 1 },
      { productId: 5, name: "Uno", price: 350, quantity: 1 },
    ],
    total: 1750,
    status: "Completed",
    tone: "primary",
  ...
  },
  {
    ...
    date: "2026-07-01",
    items: "Wingspan",
    orderItems: [{ productId: 4, name: "Wingspan", price: 2065, quantity: 1 }],
    total: 2065,
    status: "In Transit",
    tone: "soft",
  ...
  },
  {
    ...
    orderItems: [
      { productId: 3, name: "Codenames", price: 700, quantity: 1 },
      { productId: 7, name: "Dixit", price: 1050, quantity: 1 },
    ],
    total: 1750,
